...
**Training the VAE** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **world models for reinforcement learning**.
...
1. Explain the role of **Training the VAE** in world models for reinforcement learning.
...
**Previous:** [Section 12.4: Collecting Rollout Data](./section-04-collecting-rollout-data.md)  
**Next:** [Section 12.6: Training the MDN-RNN](./section-06-training-the-mdn-rnn.md)
