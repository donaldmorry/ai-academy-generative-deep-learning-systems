# Section 12.1: World Models Introduction
...
**World Models Introduction** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **world models for reinforcement learning**.
...
1. Explain the role of **World Models Introduction** in world models for reinforcement learning.
...
**Next:** [Section 12.2: Reinforcement Learning Basics](./section-02-reinforcement-learning-basics.md)
