# Section 12.4: Collecting Rollout Data
...
**Collecting Rollout Data** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **world models for reinforcement learning**.
...
1. Explain the role of **Collecting Rollout Data** in world models for reinforcement learning.
...
**Previous:** [Section 12.3: World Model Architecture](./section-03-world-model-architecture.md)  
**Next:** [Section 12.5: Training the VAE](./section-05-training-the-vae.md)
