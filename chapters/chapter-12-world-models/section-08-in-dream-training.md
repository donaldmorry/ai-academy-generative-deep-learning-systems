# Section 12.8: In-Dream Training
...
**In-Dream Training** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **world models for reinforcement learning**.
...
1. Explain the role of **In-Dream Training** in world models for reinforcement learning.
...
**Previous:** [Section 12.7: Training the Controller](./section-07-training-the-controller.md)
