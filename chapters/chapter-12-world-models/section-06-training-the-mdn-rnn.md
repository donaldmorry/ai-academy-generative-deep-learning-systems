# Section 12.6: Training the MDN-RNN
...
**Training the MDN-RNN** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **world models for reinforcement learning**.
...
1. Explain the role of **Training the MDN-RNN** in world models for reinforcement learning.
...
**Previous:** [Section 12.5: Training the VAE](./section-05-training-the-vae.md)  
**Next:** [Section 12.7: Training the Controller](./section-07-training-the-controller.md)
