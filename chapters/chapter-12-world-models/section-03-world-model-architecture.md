# Section 12.3: World Model Architecture
...
**World Model Architecture** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **world models for reinforcement learning**.
...
1. Explain the role of **World Model Architecture** in world models for reinforcement learning.
...
**Previous:** [Section 12.2: Reinforcement Learning Basics](./section-02-reinforcement-learning-basics.md)  
**Next:** [Section 12.4: Collecting Rollout Data](./section-04-collecting-rollout-data.md)
