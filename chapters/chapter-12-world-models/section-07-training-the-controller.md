# Section 12.7: Training the Controller
...
**Training the Controller** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **world models for reinforcement learning**.
...
1. Explain the role of **Training the Controller** in world models for reinforcement learning.
...
**Previous:** [Section 12.6: Training the MDN-RNN](./section-06-training-the-mdn-rnn.md)  
**Next:** [Section 12.8: In-Dream Training](./section-08-in-dream-training.md)
