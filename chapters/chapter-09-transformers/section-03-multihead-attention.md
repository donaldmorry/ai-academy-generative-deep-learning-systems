# Section 9.3: Multihead Attention
...
**Multihead Attention** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **transformer language modeling**.
...
1. Explain the role of **Multihead Attention** in transformer language modeling.
...
**Previous:** [Section 9.2: Attention Mechanism](./section-02-attention-mechanism.md)  
**Next:** [Section 9.4: Causal Masking](./section-04-causal-masking.md)
