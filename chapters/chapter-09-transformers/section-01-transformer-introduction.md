# Section 9.1: Transformer Introduction
...
**Transformer Introduction** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **transformer language modeling**.
...
1. Explain the role of **Transformer Introduction** in transformer language modeling.
...
**Next:** [Section 9.2: Attention Mechanism](./section-02-attention-mechanism.md)
