# Section 9.6: Positional Encoding
...
**Positional Encoding** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **transformer language modeling**.
...
1. Explain the role of **Positional Encoding** in transformer language modeling.
...
**Previous:** [Section 9.5: Transformer Block](./section-05-transformer-block.md)  
**Next:** [Section 9.7: Training GPT](./section-07-training-gpt.md)
