# Section 9.9: T5 & Other Transformers
...
**T5 & Other Transformers** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **transformer language modeling**.
...
1. Explain the role of **T5 & Other Transformers** in transformer language modeling.
...
**Previous:** [Section 9.8: GPT-3, GPT-4 & ChatGPT](./section-08-gpt-3-gpt-4-and-chatgpt.md)
