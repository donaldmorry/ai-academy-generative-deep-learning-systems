# Section 9.8: GPT-3, GPT-4 & ChatGPT
...
**GPT-3, GPT-4 & ChatGPT** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **transformer language modeling**.
...
1. Explain the role of **GPT-3, GPT-4 & ChatGPT** in transformer language modeling.
...
**Previous:** [Section 9.7: Training GPT](./section-07-training-gpt.md)  
**Next:** [Section 9.9: T5 & Other Transformers](./section-09-t5-and-other-transformers.md)
