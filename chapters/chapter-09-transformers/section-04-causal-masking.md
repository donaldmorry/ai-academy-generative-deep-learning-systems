...
**Causal Masking** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **transformer language modeling**.
...
1. Explain the role of **Causal Masking** in transformer language modeling.
...
**Previous:** [Section 9.3: Multihead Attention](./section-03-multihead-attention.md)  
**Next:** [Section 9.5: Transformer Block](./section-05-transformer-block.md)
