...
**VQ-GAN** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **advanced GAN image synthesis**.
...
1. Explain the role of **VQ-GAN** in advanced GAN image synthesis.
...
**Previous:** [Section 10.6: BigGAN](./section-06-biggan.md)  
**Next:** [Section 10.8: ViT-VQGAN & Summary](./section-08-vit-vqgan-and-summary.md)
