# Section 10.5: Self-Attention GAN (SAGAN)
...
**Self-Attention GAN (SAGAN)** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **advanced GAN image synthesis**.
...
1. Explain the role of **Self-Attention GAN (SAGAN)** in advanced GAN image synthesis.
...
**Previous:** [Section 10.4: StyleGAN2](./section-04-stylegan2.md)  
**Next:** [Section 10.6: BigGAN](./section-06-biggan.md)
