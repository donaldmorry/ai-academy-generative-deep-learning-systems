# Section 11.2: Parsing MIDI Files
...
**Parsing MIDI Files** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **symbolic music generation**.
...
1. Explain the role of **Parsing MIDI Files** in symbolic music generation.
...
**Previous:** [Section 11.1: Music Generation Introduction](./section-01-music-generation-introduction.md)  
**Next:** [Section 11.3: Tokenization](./section-03-tokenization.md)
