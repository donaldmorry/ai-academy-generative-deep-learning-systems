# Section 11.4: Music Transformer
...
**Music Transformer** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **symbolic music generation**.
...
1. Explain the role of **Music Transformer** in symbolic music generation.
...
**Previous:** [Section 11.3: Tokenization](./section-03-tokenization.md)  
**Next:** [Section 11.5: Training & Analysis](./section-05-training-and-analysis.md)
