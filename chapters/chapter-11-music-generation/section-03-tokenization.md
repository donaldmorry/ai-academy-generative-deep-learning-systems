...
**Tokenization** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **symbolic music generation**.
...
1. Explain the role of **Tokenization** in symbolic music generation.
...
**Previous:** [Section 11.2: Parsing MIDI Files](./section-02-parsing-midi-files.md)  
**Next:** [Section 11.4: Music Transformer](./section-04-music-transformer.md)
