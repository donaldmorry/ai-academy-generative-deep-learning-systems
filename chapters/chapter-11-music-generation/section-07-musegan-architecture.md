# Section 11.7: MuseGAN Architecture
...
**MuseGAN Architecture** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **symbolic music generation**.
...
1. Explain the role of **MuseGAN Architecture** in symbolic music generation.
...
**Previous:** [Section 11.6: Polyphonic Tokenization](./section-06-polyphonic-tokenization.md)  
**Next:** [Section 11.8: MuseGAN Training & Analysis](./section-08-musegan-training-and-analysis.md)
