# Section 11.6: Polyphonic Tokenization
...
**Polyphonic Tokenization** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **symbolic music generation**.
...
1. Explain the role of **Polyphonic Tokenization** in symbolic music generation.
...
**Previous:** [Section 11.5: Training & Analysis](./section-05-training-and-analysis.md)  
**Next:** [Section 11.7: MuseGAN Architecture](./section-07-musegan-architecture.md)
