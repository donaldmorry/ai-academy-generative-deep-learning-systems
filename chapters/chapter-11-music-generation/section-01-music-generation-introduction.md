# Section 11.1: Music Generation Introduction
...
**Music Generation Introduction** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **symbolic music generation**.
...
1. Explain the role of **Music Generation Introduction** in symbolic music generation.
...
**Next:** [Section 11.2: Parsing MIDI Files](./section-02-parsing-midi-files.md)
