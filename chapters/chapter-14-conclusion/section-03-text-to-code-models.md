# Section 14.3: Text-to-Code Models
...
**Text-to-Code Models** is part of the course's advanced generative AI arc. The source chapter supplies the motivating architecture and examples; this section turns them into a reusable engineering pattern for **generative AI synthesis and responsible deployment**.
...
1. Explain the role of **Text-to-Code Models** in generative AI synthesis and responsible deployment.
...
**Previous:** [Section 14.2: Current State: LLMs](./section-02-current-state-llms.md)  
**Next:** [Section 14.4: Text-to-Image Models](./section-04-text-to-image-models.md)
